Refactor @backend/ai_generator.py to suppport sequential tool calling where Claude can make up to 2 tool calls in seperate API rounds.
...
- Support for complex queries requiring multiple searches for comparisons, multi-part questions, or when information from different courses/lesson is needed

Example flow:
1. User: "Searching for a course that discusses the same topic as lesson 4 of course X"
